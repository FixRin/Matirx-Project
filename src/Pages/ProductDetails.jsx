"use client";
import tshirt from "../Assets/Images/Ekran_görüntüsü_2025-01-26_103224-removebg-preview.png";
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="aspect-square relative overflow-hidden rounded-md">
              <img
                src={tshirt}
                alt="Woman wearing a black basic tee"
          ...
          <div className="space-y-6">
            <div>
              <div className="flex justify-between items-start">
                <h1 className="text-2xl font-medium">Basic Tee</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="flex-1  h-[40px] mx-5 button-cutout-black group justify-center   inline-flex items-center bg-gradient-to-b from-25% to-75% bg-[length:100%_400%] font-bold transition-[filter,background-position] duration-300 hover:bg-bottom gap-3 px-1 text-lg ~py-2.5/3 from-brand-purple to-brand-lime text-white hover:text-black">
                  Add to cart
                </button>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    Looking for the perfect tee? The Basic Tee is comfortable in
                    a range of situations and pairs well with anything.
                  </p>
                </div>
