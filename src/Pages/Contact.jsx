  ...
  return (
    <div   className={` ${
      ...
      <div className="container-contact ">
        <div className="py-20 grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-7xl   ">
          <div>
            <h1 className="text-gray-800 text-3xl font-extrabold">
            {items[6][Lang].Contact[17]}
            </h1>
            <p className="text-sm text-gray-500 mt-4">
            {items[6][Lang].Contact[18]}
            </p>
            <div className="mt-12">
              ...
              <ul className="mt-4">
                <li className="flex items-center">
                  ...
                  >
                    ...
                    <strong>Contact@PixelWear.com</strong>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <form className="ml-auto space-y-4">
            ...
            <button
              type="submit"
              style={{ height: "50px" }}
              className="w-[92%] mt-5 mx-5 button-cutout-black group justify-center   inline-flex items-center bg-gradient-to-b from-25% to-75% bg-[length:100%_400%] font-bold transition-[filter,background-position] duration-300 hover:bg-bottom gap-3 px-1 text-lg ~py-2.5/3 from-brand-purple to-brand-lime text-white hover:text-black"
            >
              Send
            </button>
          </form>
